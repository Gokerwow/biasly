                            ...
                            <div className="flex flex-wrap justify-center lg:justify-start gap-4">
                                ...
                                <button className="px-8 py-4 rounded-full bg-white/80 backdrop-blur-sm text-kpop-black hover:bg-white transition-all duration-300 font-semibold flex items-center transform hover:scale-105">
                                    ...
                                    className="w-8"
                                        ...
                                        xmlnsXlink="http://www.w3.org/1999/xlink" // Perubahan di sini
                                        fill="#000000"
                                    >
                                        <g id="SVGRepo_bgCarrier" strokeWidth="0"></g> {/* Perubahan di sini */}
                                        <g id="SVGRepo_tracerCarrier" strokeLinecap="round" strokeLinejoin="round"></g> {/* Perubahan di sini */}
                                        <g id="SVGRepo_iconCarrier">
                                            <title>Youtube-color</title>
                                            <desc>Created with Sketch.</desc>
                                            <defs></defs>
                                            <g id="Icons" stroke="none" strokeWidth="1" fill="none" fillRule="evenodd"> {/* Perubahan di sini */}
