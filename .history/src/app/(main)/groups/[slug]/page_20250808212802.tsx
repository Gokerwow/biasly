                    ...
                    <div className="flex flex-col lg:flex-row items-center gap-12">
                        ...
                        <div className="lg:w-1/2 text-center lg:text-left animate-slide-up">
                            ...
                            <div className="flex flex-wrap justify-center lg:justify-start gap-4">
                                ...
                                <button className="relative px-8 py-4 rounded-full bg-white/80 backdrop-blur-sm text-kpop-black hover:bg-white transition-all duration-300 font-semibold flex items-center transform hover:scale-105">
                                    <Image
