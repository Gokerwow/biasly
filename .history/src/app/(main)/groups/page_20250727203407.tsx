    ...
    return (
        <div className="pt-18">
            ...
            <div class="mt-8 max-w-md mx-auto">
                <div class="relative">
                    <input type="text" placeholder="Search groups..." class="w-full pl-12 pr-4 py-3 rounded-full bg-white/90 focus:outline-none focus:ring-2 focus:ring-purple-300 shadow-lg">
                    <svg class="absolute left-4 top-3.5 h-5 w-5 text-purple-400" fill="none" viewBox="0 0 24 24" stroke="currentColor">
