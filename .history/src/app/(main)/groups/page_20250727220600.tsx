...
<div class="p-4">
                    <div class="flex justify-between items-center mb-4">
                        ...
                        <span class="text-xs bg-purple-100 text-purple-800 px-2 py-1 rounded-full">5 Members</span>
                    </div>
                    <div class="mb-3">
                        <p class="text-sm text-gray-600">Debut: 2022</p>
                        <p class="text-sm text-gray-600">Latest: "Easy"</p>
                    </div>
