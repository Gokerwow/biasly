            ...
            <main className="containerPad">
                ...
                <div className="grid grid-cols-4">
                    <div className="bg-white rounded-xl overflow-hidden shadow-md cursor-pointer">
                        ...
                        <span class="text-xs bg-pink-100 text-pink-800 px-2 py-1 rounded-full">Chic</span>
                        <span class="text-xs bg-purple-100 text-purple-800 px-2 py-1 rounded-full">Pop</span>
                        <span class="text-xs bg-blue-100 text-blue-800 px-2 py-1 rounded-full">Elegant</span>
                    </div>
                            <div className="mb-3">
                                <p className="text-sm text-gray-600">Debut: 2022</p>
                                <p className="text-sm text-gray-600">Latest: &quot;Easy&quot;</p>
                            </div>
