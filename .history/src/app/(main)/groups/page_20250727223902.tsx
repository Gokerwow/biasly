                    ...
                    <div className="bg-white rounded-xl overflow-hidden shadow-md cursor-pointer hover:shadow-lg transition-shadow duration-300">
                        <div className="relative h-60 overflow-hidden">
                            ...
                            <div className="absolute bottom-0 left-0 p-4">
                                <h1 className="text-white font-bold text-xl drop-shadow-md">ITZY</h1>
                                <h2 className="text-purple-200 text-sm drop-shadow-md">JYP entertainment</h2>
                            </div>
                            <div className="absolute top-3 right-3">
                                <button className="p-2 bg-white/60 rounded-full hover:bg-white cursor-pointer transition-colors duration-200 group">
...
<div className="mb-3 flex items-start gap-4">
    <div className="flex-1">
        ...
        <p className="text-sm font-semibold text-gray-800 ml-6">Feb 12, 2019</p>
        <p className="text-xs text-gray-500 ml-6">"DALLA DALLA"</p>
    </div>
    ...
    <div className="flex-1">
        ...
        <p className="text-sm font-semibold text-gray-800 ml-6">Jul 15, 2023</p>
        <p className="text-xs text-gray-500 ml-6">"CAKE"</p>
    </div>
</div>
