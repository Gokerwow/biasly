...
import { cleanFandomImageUrl } from "@/utils/image";
    ...
    return (
        ...
        <div class="mt-12 flex justify-center">
            <nav class="flex items-center space-x-1">
                <button class="p-2 rounded-full bg-purple-600 text-white hover:bg-purple-700">
                    <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M15 19l-7-7 7-7" />
                    </svg>
                </button>
                <button class="px-4 py-2 rounded-full bg-purple-600 text-white font-medium">1</button>
                <button class="px-4 py-2 rounded-full bg-white text-purple-600 border border-purple-200 font-medium hover:bg-purple-50">2</button>
                <button class="px-4 py-2 rounded-full bg-white text-purple-600 border border-purple-200 font-medium hover:bg-purple-50">3</button>
                <button class="px-4 py-2 rounded-full bg-white text-purple-600 border border-purple-200 font-medium hover:bg-purple-50">4</button>
                <button class="p-2 rounded-full bg-purple-600 text-white hover:bg-purple-700">
                    <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
