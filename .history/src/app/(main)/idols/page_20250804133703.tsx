        ...
        <div className="py-18">
            ...
            <div className="containerPad">
                ...
                <div class="relative h-full">
                    <img src="https://via.placeholder.com/400x500/B9E6FF/FFFFFF?text=TAEYONG" class="idol-image w-full h-full object-cover">
                    <div class="idol-info absolute bottom-0 left-0 right-0 p-4 text-white">
                        <h3 class="text-xl font-bold">TAEYONG</h3>
                        <p class="text-sm mb-2">NCT</p>
                        <div class="flex gap-2">
                            <span class="bg-white bg-opacity-20 px-2 py-1 rounded-full text-xs">Leader</span>
