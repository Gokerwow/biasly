                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-6">
                    <div className="idol-card bg-white rounded-xl overflow-hidden shadow-md h-80 relative">
                        <div className="relative h-full">
                            <img alt='idol photo' src="https://via.placeholder.com/400x500/B9E6FF/FFFFFF?text=TAEYONG" className="idol-image w-full h-full object-cover"/>
                            <div className="idol-info absolute bottom-0 left-0 right-0 p-4 text-white">
                                <h3 className="text-xl font-bold">TAEYONG</h3>
                                <p className="text-sm mb-2">NCT</p>
