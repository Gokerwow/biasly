export default function IdolsPage() {
    return (
        <div className="py-18">
            ...
            <div class="idol-card bg-white rounded-xl overflow-hidden shadow-md h-80 relative">
                <div class="relative h-full">
                    <img src="https://via.placeholder.com/400x500/FFC0CB/FFFFFF?text=JENNIE" class="idol-image w-full h-full object-cover">
                    <div class="idol-info absolute bottom-0 left-0 right-0 p-4 text-white">
                        <h3 class="text-xl font-bold">JENNIE</h3>
                        <p class="text-sm mb-2">BLACKPINK</p>
                        <div class="flex gap-2">
                            <span class="bg-white bg-opacity-20 px-2 py-1 rounded-full text-xs">Main Rapper</span>
                            <span class="bg-white bg-opacity-20 px-2 py-1 rounded-full text-xs">Vocalist</span>
                        </div>
                    </div>
                    <div class="absolute top-3 right-3 bg-pink-600 text-white px-2 py-1 rounded-full text-xs font-bold shadow-md">
                        9.2M
                    </div>
                </div>
            </div>
