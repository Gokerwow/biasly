export default function IdolsPage() {
    return (
        <div className="py-18">
            ...
            <div class="idol-card bg-white rounded-xl overflow-hidden h-96 relative">
                <div class="idol-image-container h-full">
                    <img src="https://via.placeholder.com/600x800/F3F4F6/10B981?text=YUNA" class="idol-image w-full h-full object-cover">
                </div>
                <div class="idol-info absolute bottom-0 left-0 right-0 bg-gradient-to-t from-black/70 to-transparent p-6 text-white">
                    <h3 class="text-2xl font-bold">YUNA</h3>
                    <p class="text-emerald-300 mb-3">ITZY</p>
                    <div class="flex flex-wrap gap-2 mb-3">
                        <span class="role-tag bg-pink-600/90 text-white px-3 py-1 rounded-full text-xs">Visual</span>
                    </div>
                ...
                <div class="absolute top-4 right-4 bg-white text-emerald-500 px-3 py-1 rounded-full text-xs font-bold shadow-md">
                    RISING STAR
                </div>
            </div>
        </div>
