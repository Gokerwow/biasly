            ...
            <div className="containerPad">
                <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-6">
                    <div className="idol-card bg-white rounded-xl overflow-hidden shadow-md h-80 relative">
                        <div className="idol-card bg-white rounded-xl overflow-hidden h-96 relative">
                            <div className="idol-image-container h-full">
                                <img src="assets/images/" className="idol-image w-full h-full object-cover"/>
                            </div>
                            <div className="idol-info absolute bottom-0 left-0 right-0 bg-gradient-to-t from-black/70 to-transparent p-6 text-white">
