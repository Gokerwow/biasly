...
<div class="max-w-xs rounded-lg overflow-hidden shadow-lg bg-gradient-to-br from-purple-400 via-pink-500 to-yellow-300 p-1 hover:rotate-1 transition-transform">
  <div class="bg-white bg-opacity-90 rounded-md overflow-hidden">
    <img 
    ...
    <div class="p-4">
      <div class="flex justify-between items-center">
        <h3 class="text-xl font-bold text-purple-800">Nama Idol</h3>
        <span class="bg-yellow-200 text-yellow-800 px-2 py-1 rounded-full text-xs font-bold">UR</span>
      </div>
      <p class="text-gray-700 mt-1">✨ Limited Edition</p>
    </div>
  </div>
</div>
                </div>
