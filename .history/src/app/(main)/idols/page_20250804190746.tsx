                        ...
                        />
                            ...
                            <div className="p-4 bg-pink-50">
                                <div className="flex justify-between items-center">
                                    <h3 className="text-xl font-bold text-pink-700">Nama Idol</h3>
                                    <span className="bg-pink-200 text-pink-800 px-2 py-1 rounded-full text-xs font-semibold">Grup</span>
                                </div>
                                <p className="text-gray-600 mt-1">Main Vocal</p>
                            </div>
                    </div>
                </div>
            </div>
