            ...
            <div className="containerPad">
                <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-6">
                    <div className="group bg-white rounded-xl overflow-hidden shadow-md h-96 relative">
                        ...
                        <div className="absolute bottom-0 left-0 right-0 bg-gradient-to-t from-black/80 to-transparent p-6 text-white max-h-[130px] group-hover:max-h-[300px] transition-all duration-300">
