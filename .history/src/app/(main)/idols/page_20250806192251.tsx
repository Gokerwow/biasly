    ...
    return (
        <div className="py-18">
            ...
            <div class="flex flex-wrap items-center justify-between gap-4">
                <h2 id="female" class="font-display text-2xl md:text-3xl font-bold">Female Idols</h2>
                
                <div class="flex flex-wrap items-center gap-3">
                    <div class="relative">
                        <select class="appearance-none bg-white border border-gray-200 rounded-full px-4 py-2 pr-8 focus:outline-none focus:ring-2 focus:ring-idol-pink focus:border-transparent text-sm shadow-sm">
                    ...
                    <div class="flex flex-wrap gap-2">
                        <button class="filter-chip px-3 py-1.5 rounded-full bg-idol-pink text-white text-xs font-medium shadow-sm">All</button>
                        <button class="filter-chip px-3 py-1.5 rounded-full bg-white border border-gray-200 hover:bg-gray-50 text-xs font-medium shadow-sm">4th Gen</button>
                        <button class="filter-chip px-3 py-1.5 rounded-full bg-white border border-gray-200 hover:bg-gray-50 text-xs font-medium shadow-sm">3rd Gen</button>
                        <button class="filter-chip px-3 py-1.5 rounded-full bg-white border border-gray-200 hover:bg-gray-50 text-xs font-medium shadow-sm">Active</button>
                    </div>
                </div>
            </div>
        </section>
