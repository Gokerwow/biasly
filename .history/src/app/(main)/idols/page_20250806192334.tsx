        ...
        <div className="py-18">
            ...
            <section className="mb-8">
                <div className="flex flex-wrap items-center justify-between gap-4">
                    <h2 id="female" className="font-display text-2xl md:text-3xl font-bold">Female Idols</h2>
                    ...
                    <div className="flex flex-wrap items-center gap-3">
                        <div className="relative">
                            ...
                            <i className="fas fa-chevron-down absolute right-3 top-2.5 text-gray-500 text-xs"></i>
                        </div>

                        <div className="flex flex-wrap gap-2">
                            <button className="filter-chip px-3 py-1.5 rounded-full bg-idol-pink text-white text-xs font-medium shadow-sm">All</button>
                            <button className="filter-chip px-3 py-1.5 rounded-full bg-white border border-gray-200 hover:bg-gray-50 text-xs font-medium shadow-sm">4th Gen</button>
                            <button className="filter-chip px-3 py-1.5 rounded-full bg-white border border-gray-200 hover:bg-gray-50 text-xs font-medium shadow-sm">3rd Gen</button>
                            <button className="filter-chip px-3 py-1.5 rounded-full bg-white border border-gray-200 hover:bg-gray-50 text-xs font-medium shadow-sm">Active</button>
                        </div>
                    </div>
                </div>
            </section>
