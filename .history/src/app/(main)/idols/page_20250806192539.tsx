    ...
    return (
        ...
        <div class="flex flex-wrap items-center justify-between gap-4 mb-8">
            <div class="flex items-center space-x-3">
                <h2 class="font-display text-3xl tracking-tighter">Popular Idols</h2>
                <span class="px-3 py-1 rounded-full bg-gray-800 text-xs">1,248 Idols</span>
            </div>
            
            <div class="flex flex-wrap items-center gap-3">
                <div class="relative">
                    <select class="appearance-none bg-gray-800 border border-gray-700 rounded-full px-4 py-2 pr-8 focus:outline-none focus:ring-2 focus:ring-idol-pink focus:border-transparent text-sm">
                ...
                <div class="flex space-x-1">
                    <button class="px-3 py-2 rounded-full bg-idol-pink text-white text-xs font-medium">All</button>
                    <button class="px-3 py-2 rounded-full bg-gray-800 hover:bg-gray-700 text-xs font-medium">Female</button>
                    <button class="px-3 py-2 rounded-full bg-gray-800 hover:bg-gray-700 text-xs font-medium">Male</button>
                    <button class="px-3 py-2 rounded-full bg-gray-800 hover:bg-gray-700 text-xs font-medium">4th Gen</button>
                </div>
            </div>
        </div>
