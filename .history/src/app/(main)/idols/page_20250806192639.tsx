            ...
            <div className="containerPad">
                ...
                <div className="flex flex-wrap items-center justify-between gap-4 mb-8">
                    <div className="flex items-center space-x-3">
                        <h2 className="font-display text-3xl tracking-tighter">Popular Idols</h2>
                        <span className="px-3 py-1 rounded-full bg-gray-800 text-xs">1,248 Idols</span>
                    </div>

                    <div className="flex flex-wrap items-center gap-3">
                        <div className="relative">
                            <select aria-label="sort by" className="appearance-none bg-gray-100 border border-gray-700 rounded-full px-4 py-2 pr-8 focus:outline-none focus:ring-2 focus:ring-idol-pink focus:border-transparent text-sm">
                                <option>Sort by: Followers</option>
                                <option>Sort by: Popularity</option>
                                <option>Sort by: Newest</option>
                                <option>Sort by: Alphabetical</option>
                            </select>
                            <i className="fas fa-chevron-down absolute right-3 top-2.5 text-gray-400 text-xs"></i>
                        </div>

                        <div className="flex space-x-1">
                            <button className="px-3 py-2 rounded-full bg-idol-pink text-white text-xs font-medium">All</button>
                            <button className="px-3 py-2 rounded-full bg-gray-100 hover:bg-gray-700 text-xs font-medium">Female</button>
                            <button className="px-3 py-2 rounded-full bg-gray-100 hover:bg-gray-700 text-xs font-medium">Male</button>
                            <button className="px-3 py-2 rounded-full bg-gray-100 hover:bg-gray-700 text-xs font-medium">4th Gen</button>
                        </div>
                    </div>
                </div>
