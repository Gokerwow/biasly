            ...
            <div className="containerPad">
                ...
                <div className="flex flex-wrap items-center justify-between gap-4 mb-8">
                    <div className="flex items-center space-x-3">
                        ...
                        <span className="px-3 py-1 rounded-full bg-gray-100 text-xs">1,248 Idols</span>
                    </div>

                    <div className="flex flex-wrap items-center gap-3">
                        <div className="relative">
                            <select aria-label="sort by" className="appearance-none bg-gray-100 border border-gray-200 rounded-full px-4 py-2 pr-8 focus:outline-none focus:ring-2 focus:ring-idol-pink focus:border-transparent text-sm">
                        ...
                        <div className="flex space-x-1">
                            ...
                            <button className="px-3 py-2 rounded-full bg-gray-100 hover:bg-gray-200 text-xs font-medium">Female</button>
                            <button className="px-3 py-2 rounded-full bg-gray-100 hover:bg-gray-200 text-xs font-medium">Male</button>
                            <button className="px-3 py-2 rounded-full bg-gray-100 hover:bg-gray-200 text-xs font-medium">4th Gen</button>
                        </div>
                    </div>
                </div>
