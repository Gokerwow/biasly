...
export default function Home() {
  return (
    <main className="container bg-amber-700">
      ...
      <div className="flex justify-between items-center pt-5">
        ...
        <button className="w-16 h-16 rounded-full flex items-center justify-center bg-gradient-to-r from-[#8C5CF5] to-[#DE45A6] hover:from-[#7B4CE5] hover:to-[#D33A9A]shadow-lg hover:shadow-xl transition-all duration-300 group ml-2">
