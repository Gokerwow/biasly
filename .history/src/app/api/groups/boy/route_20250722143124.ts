...
export async function GET(request: Request) {
    ...
    try {
        ...
        console.log(`🔍 Found ${existingPageIds.size} groups already in the database.`);

        const newGroupsToInsert = groupsFromFandom.filter(group => !existingPageIds.has(group.pageid));
