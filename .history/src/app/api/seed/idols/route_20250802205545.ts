    ...
    try {
        ...
        if (newIdolNames.length > 0) {
            ...
            if (newIdolIds.length > 0) {
                const idolsWithGroups = cleanNewIdolDetails.map((idol, index) => { // kalo map biasa jadi [[{group_id: 1, idol_id:1}, {group_id: 2, idol_id:1}], [{group_id: 1, idol_id:2}, {group_id: 2, idol_id:2}]]
