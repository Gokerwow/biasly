    ...
    try {
        ...
        if (newIdolNames.length > 0) {
            ...
            if (idolsToInsert.length > 0) {
                ...
                if (!insertData) {
                    console.error('Tidak ada data yang dimasukkan, kemungkinan tidak ada idol baru yang valid.');
                    return NextResponse.json({ message: 'Tidak ada idol baru yang valid untuk dimasukkan.' }, { status: 200 });
                }
