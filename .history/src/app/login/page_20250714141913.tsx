    ...
    return (
        <div className="min-h-screen flex items-center justify-center p-4">
            <div className="w-full max-w-md bg-white rounded-xl shadow-lg overflow-hidden">
                <div className="mb-4 p-4 bg-gray-100 border border-gray-300 text-gray-800 rounded-lg text-center">
                ...
                <div className="p-8">
                    ...
                    <form className="space-y-6">
                        ...
                        <div className="space-y-3">
                            ...
                            <button
                                formAction={signup}
                                className="w-full bg-white hover:bg-gray-50 text-gray-800 font-medium py-3 px-4 rounded-lg border border-gray-300 transition duration-200 shadow-sm hover:shadow-md"
                            >
                                Create new account
                            </button>
                        </div>
