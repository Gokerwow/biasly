...
<div className="flex flex-col items-center gap-8 pt-5">
  ...
  <button className="px-6 py-2 text-lg font-medium relative group">
    <span className="text-gray-700 group-hover:text-gray-900 transition-colors">Show More</span>
    <span className="absolute left-1/2 -bottom-1 h-0.5 w-0 bg-gradient-to-r from-[#8C5CF5] to-[#DE45A6] 
