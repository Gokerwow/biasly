    ...
    return (
        <div className="bg-white rounded-xl overflow-hidden shadow-md cursor-pointer hover:shadow-lg transition-shadow duration-300">
            <div className="relative h-60 overflow-hidden">
                <Image
                    src='https://static.wikia.nocookie.net/kpop/images/3/31/1VERSE_The_1st_Verse_group_concept_photo_5.png/revision/latest/scale-to-width-down/536?cb=20250714105525 2x\'
                    alt="Group Photo"
                    fill
