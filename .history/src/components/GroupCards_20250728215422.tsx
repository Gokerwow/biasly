...
export default function GroupCards({ name, agency, genres, imageUrl }: GroupCardsProps) {
    ...
    // ...Anda bisa tambahkan sebanyak yang Anda mau di sini
];
                        return <span key={index} className="text-xs bg-pink-100 text-pink-800 px-2 py-1 rounded-full font-medium">{genre}</span>
                    })}
