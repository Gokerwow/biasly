...
export default function IdolsCard({ name }: IdolsCardProps) {
    return (
        <div className="group bg-white rounded-xl overflow-hidden shadow-md h-96 relative cursor-pointer hover:shadow-lg hover:-translate-y-4 transition-all duration-300">
            <div className="h-full relative">
                <Image alt='idol photos' src="/assets/images/1080full-yuna-(itzy).jpg" className="object-cover group-hover:scale-110 transition-all duration-300" fill />
            </div>
