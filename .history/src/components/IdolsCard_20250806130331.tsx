...
export default function IdolsCard({ name }: IdolsCardProps) {
    return (
        <div className="bg-white rounded-xl overflow-hidden shadow-card hover:shadow-card-hover hover:-translate-y-5 transition-all duration-200 shadow-lg">
            <div className="relative">
                ...
                <div className="absolute top-3 right-3">
                    <button className="w-8 h-8 rounded-full bg-white/90 hover:bg-idol-pink flex items-center justify-center text-gray-700 hover:text-white transition shadow-sm">
                        <Heart size={15} />
                    </button>
                </div>
