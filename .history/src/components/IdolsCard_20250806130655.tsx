        ...
        <div className="bg-white rounded-xl overflow-hidden shadow-md hover:shadow-card-hover hover:-translate-y-5 transition-all duration-200 hover:shadow-lg">
            <div className="relative">
                ...
                <div className="absolute top-3 right-3">
                    <button aria-label='favourite button' className="w-8 h-8 rounded-full bg-white/90 hover:bg-idol-pink flex items-center justify-center text-gray-700 hover:text-white transition shadow-sm">
                        <Heart size={15} />
                    </button>
                </div>
            ...
            <div className="p-5">
                ...
                <button className="w-full py-2.5 rounded-lg bg-gray-100 hover:bg-gray-200 text-gray-800 font-medium text-sm transition flex items-center justify-center">
                    View Full Profile <ChevronRight className='ml-4'/>
                </button>
            </div>
        </div>
    )
