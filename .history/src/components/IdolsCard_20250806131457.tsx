    ...
    return (
        <div className="bg-white rounded-xl overflow-hidden shadow-md hover:shadow-card-hover hover:-translate-y-5 transition-all duration-200 hover:shadow-lg">
            <div className="relative">
                ...
                <div className="absolute bottom-3 right-3 px-3 py-1 rounded-full text-gray-800 text-xs font-medium shadow-sm bg-[linear-gradient(135deg, rgba(255,255,255,0.9) 0%, rgba(255,255,255,0.8)]">
