    ...
    return (
        <div className="bg-white rounded-xl overflow-hidden shadow-md hover:shadow-card-hover hover:-translate-y-5 transition-all duration-200 hover:shadow-lg">
            ...
            <div className="p-5">
                ...
                <button className="w-full py-2.5 rounded-lg bg-gradient-to-r from-[#9900FF] to-[#EB4899] hover:to-[#9900FF] font-medium text-sm transition flex items-center justify-center cursor-pointer text-white">
