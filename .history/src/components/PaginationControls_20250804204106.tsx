    ...
    return (
        <div className="mt-12 flex justify-center">
            <nav className="flex items-center space-x-1">
                <Link href={`/groups?page=${currentPage - 1}`} aria-label="previous pagination" className={`p-2 rounded-full bg-purple-600 text-white hover:bg-purple-700 cursor-pointer hover:scale-110 transition-all duration-200 ${currentPage === 1 ? '' : 'disabled:'}`}>
