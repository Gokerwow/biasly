...
export default function Navbar() {
    return (
        <nav className=" bg-white flex justify-center items-center px-20">
            <header>
                <Image
            ...
            <ul className="text-black bg-[#F9F9F9] flex items-center h-full px-5 rounded-2xl border-1 border-gray-400 mx-auto">
