        ...
        <nav className="fixed w-full bg-white flex justify-between items-center px-20 shadow-xl">
            ...
            <div className="flex gap-2">
                {user ? (
                    ...
                    <>
                        <Link className="px-5 py-1 rounded-2xl border-1 border-gray-400">
                            Sign In
                        </Link>
                        <Link className="px-5 py-1 rounded-2xl border-1 bg-gradient-to-r from-[#9534E8] to-[#EA479B] text-white">
                            Join
                        </Link>
                    </>
                )}
