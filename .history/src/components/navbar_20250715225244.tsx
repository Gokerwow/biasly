        ...
        const fetchUserProfile = async () => {
            ...
            if (session) {
                ...
                const { data: profileData } = await supabase
                    .from('profiles')
                    .select('username, avatar_url, bio') // Ambil kolom yang dibutuhkan
            ...
            <div className="flex gap-2">
                {user ? (
                    <div className="w-13 h-13 rounded-full overflow-hidden relative">
                        <Image
                            src={avatarUrl ?? "https://kzcucrksqzdypkmlviex.supabase.co/storage/v1/object/public/avatars//221218-ITZY-Yuna-documents-1(2).jpeg"}
