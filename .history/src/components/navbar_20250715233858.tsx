...
{isDropdownOpen && (
  <div className="absolute right-0 mt-2 w-56 origin-top-right bg-white rounded-lg shadow-md border border-gray-100">
    <div className="px-4 py-3 text-sm">
      <p className="font-medium text-gray-900 truncate">Signed in as</p>
    ...
    <div className="py-1">
      ...
      <Link href="/support" className="block px-4 py-2 text-sm text-gray-700 hover:bg-gray-50">
        Customer Support
      </Link>
    </div>
