...
export default function Navbar() {
    ...
    const IdolIcon = () => (
        <svg viewBox="0 0 24 24" className="w-5 h-5 text-pink-600">
            ...
            {/* Mata bintang */}
            <polygon points="9,8 10,6 12,7 14,6 15,8 14,10 12,9 10,10" fill="currentColor" />
            <polygon points="15,8 16,6 18,7 20,6 21,8 20,10 18,9 16,10" fill="currentColor" />
            {/* Dekorasi hati */}
            <path d="M12 15 L10 17 L12 19 L14 17 Z" fill="#ff4d8d" />
        </svg>
    );
                                ...
                                <div className="divide-y divide-pink-100/50">
                                    <Link href="/profile" className="flex items-center px-6 py-4 hover:bg-pink-50/70 transition-all">
                                        <div className="bg-pink-100 p-2 rounded-lg mr-4">
                                            <IdolIcon className="text-pink-600 w-5 h-5" />
                                        </div>
                                        <div>
