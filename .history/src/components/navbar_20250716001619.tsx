            ...
            <div className="flex gap-2">
                {user ? (
                    <>
                        ...
                        <div id="profile-menu" className="hidden absolute right-0 mt-2 w-56 origin-top-right rounded-2xl bg-white shadow-xl border border-pink-200 overflow-hidden z-50">
                            <div className="bg-pink-100 px-4 py-3">
                                <p className="text-xs text-pink-600">MY PROFILE</p>
                                <p className="text-sm font-bold text-pink-800 truncate">STAN ACCOUNT</p>
                            </div>

                            <div className="p-2">
                                <a href="#" className="flex items-center px-4 py-2.5 rounded-xl text-sm text-pink-900 hover:bg-pink-50 mb-1 transition-all">
                                    <div className="w-8 h-8 rounded-lg bg-pink-100 flex items-center justify-center mr-3">
                                        <svg xmlns="http://www.w3.org/2000/svg" className="h-4 w-4 text-pink-500" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                            <path strokeLinecap="round" stroke-linejoin="round" stroke-width="2" d="M16 7a4 4 0 11-8 0 4 4 0 018 0zM12 14a7 7 0 00-7 7h14a7 7 0 00-7-7z" />
                                        </svg>
                                    </div>
                                    Profile
                                </a>
                                <a href="#" className="flex items-center px-4 py-2.5 rounded-xl text-sm text-pink-900 hover:bg-pink-50 mb-1 transition-all">
                                    <div className="w-8 h-8 rounded-lg bg-pink-100 flex items-center justify-center mr-3">
                                        <svg xmlns="http://www.w3.org/2000/svg" className="h-4 w-4 text-pink-500" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                            <path strokeLinecap="round" stroke-linejoin="round" stroke-width="2" d="M10.325 4.317c.426-1.756 2.924-1.756 3.35 0a1.724 1.724 0 002.573 1.066c1.543-.94 3.31.826 2.37 2.37a1.724 1.724 0 001.065 2.572c1.756.426 1.756 2.924 0 3.35a1.724 1.724 0 00-1.066 2.573c.94 1.543-.826 3.31-2.37 2.37a1.724 1.724 0 00-2.572 1.065c-.426 1.756-2.924 1.756-3.35 0a1.724 1.724 0 00-2.573-1.066c-1.543.94-3.31-.826-2.37-2.37a1.724 1.724 0 00-1.065-2.572c-1.756-.426-1.756-2.924 0-3.35a1.724 1.724 0 001.066-2.573c-.94-1.543.826-3.31 2.37-2.37.996.608 2.296.07 2.572-1.065z" />
                                            <path strokeLinecap="round" stroke-linejoin="round" stroke-width="2" d="M15 12a3 3 0 11-6 0 3 3 0 016 0z" />
                                        </svg>
                                    </div>
                                    Settings
                                </a>
                                <a href="#" className="flex items-center px-4 py-2.5 rounded-xl text-sm text-red-500 hover:bg-red-50 transition-all">
