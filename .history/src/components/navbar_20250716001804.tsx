            ...
            <div className="flex gap-2">
                {user ? (
                    <>
                        ...
                        <div id="profile-menu" className="hidden absolute right-0 mt-2 w-56 origin-top-right rounded-lg bg-white shadow-xl z-50 overflow-hidden border border-gray-200">
                            <div className="h-16 bg-gradient-to-r from-blue-400 to-purple-500 relative">
                                <div className="absolute -bottom-4 left-4 w-8 h-8 rounded-lg overflow-hidden border-2 border-white shadow-md">
                                    <Image src="https://i.pinimg.com/564x/d4/d4/d4/d4d4d4d4d4d4d4d4d4d4d4d4d4d4d4.jpg" alt="Profile" fill className="w-full h-full object-cover"/>
                                </div>
                            </div>

                            <div className="pt-6 pb-2 px-4">
                                <p className="text-sm font-bold text-gray-900">KPop Stan Account</p>
                                <p className="text-xs text-gray-500">premium member</p>
                            </div>

                            <div className="py-1 border-t border-gray-100">
                                <a href="#" className="flex items-center px-4 py-2 text-sm text-gray-700 hover:bg-blue-50">
                                    <span className="w-1 h-1 rounded-full bg-blue-500 mr-3"></span>
                                    Profile
                                </a>
                                <a href="#" className="flex items-center px-4 py-2 text-sm text-gray-700 hover:bg-blue-50">
                                    <span className="w-1 h-1 rounded-full bg-blue-500 mr-3"></span>
                                ...
                                <a href="#" className="flex items-center px-4 py-2 text-sm text-red-500 hover:bg-red-50">
                                    <span className="w-1 h-1 rounded-full bg-red-500 mr-3"></span>
                                    Logout
                                </a>
                            </div>
                        </div>
