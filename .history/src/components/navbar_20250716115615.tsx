                    ...
                    <>
                        ...
                        {isDropdown && (
                            <div className="absolute right-0 mt-2 w-64 origin-top-right bg-white rounded-xl shadow-lg ring-1 ring-gray-100 overflow-hidden">
                                ...
                                <div className="py-1">
                                    {[
                                        { icon: <Star className="w-4 h-4 text-pink-500" />, label: "Fan Profile" },
                                        { icon: <Music className="w-4 h-4 text-purple-500" />, label: "Playlists" },
                                        { icon: <Ticket className="w-4 h-4 text-blue-500" />, label: "Concert Tickets" },
                                        { icon: <TbFriends className="w-4 h-4 text-blue-500" />, label: "Concert Tickets" },
