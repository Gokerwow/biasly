...
import { Bookmark, Heart, LifeBuoy, LogOut, Music, Settings, Star, Ticket, UserIcon } from "lucide-react"
            ...
            <div className="flex gap-2 relative">
                {user ? (
                    <>
                        ...
                        {isDropdown && (
                            <div className="absolute right-0 top-0 mt-2 w-64 origin-top-right bg-white rounded-xl shadow-lg ring-1 ring-gray-100 overflow-hidden">
