            ...
            <div className="flex gap-2 relative group">
                {user ? (
                    <>
                        ...
                        <div className="hidden absolute right-0 top-[10z0%] group-hover:block hover:block w-64 origin-top-right bg-white rounded-xl shadow-lg ring-1 ring-gray-100 overflow-hidden">
