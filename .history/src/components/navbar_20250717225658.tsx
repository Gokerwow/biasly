...
export default function Navbar() {
    ...
    return (
        <nav className="fixed w-full bg-white flex justify-between items-center px-20 shadow-mdd">
            <header>
                <Image
                ...
                {user ? (
                    <>
                        ...
                        <div className="hidden absolute right-0 top-[100%] group-hover:block hover:block w-64 origin-top-right bg-white rounded-xl shadow-lg ring-1 ring-gray-100 overflow-hidden">
                            ...
                            <div className="px-5 py-3 border-t border-gray-100 bg-gray-50 hover:bg-gray-200 transition-colors duration-200">
                                <button
