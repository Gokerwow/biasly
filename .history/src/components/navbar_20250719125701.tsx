...
export default function Navbar() {
    ...
    return (
        <nav className="fixed w-full bg-white grid grid-cols-3 items-center px-20 shadow-md">
            ...
            <ul className="text-black bg-[#F9F9F9] flex justify-center justify-self-center items-center h-full px-5 rounded-2xl border-1 border-gray-400">
            ...
            <div className="flex gap-2 relative justify-end">
                {user ? (
                    <>
                        <div className="w-13 h-13 rounded-full group overflow-hidden relative cursor-pointer">
                            <Image
                            ...
                            <div className="py-1">
                                {[
                                    ...
                                    <Link
                                        key={index}
                                        href="#"
                                        className="flex items-center px-5 py-3 text-sm text-gray-700 hover:bg-gray-50 transition-colors duration-200"
                                    >
