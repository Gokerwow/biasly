...
import { Book, IdCardLanyard, Layers, Save, Star, Tag, Upload, User, Users, X } from "lucide-react"
import { useRouter } from "next/navigation"
import { useEffect, useState, useRef } from "react"
import { nanoid } from 'nanoid'
import { useUser } from "@/app/providers/authProvider"
import { ArtistType, PhotocardDataPayload } from "@/types"
...
interface FormState {
    ...
    card_physical: CardPhysicalDropdown | null
    rarity: CardRarity
...
export default function AddCardClient() {
    ...
    useEffect(() => {
        console.log("INI YA COPK", formData.idol_ids)
    }, [formData.idol_ids])
    ...
    useEffect(() => {
        const fetchCardTypes = async () => {
            ...
            try {
                ...
                console.log('EH KONTOL INTI YA', distrbutionTypes)
                console.log('EH KONTOL INTI YA', physicalTypes)
                            ...
                            <div className="space-y-4">
                                ...
                                <div className="grid grid-cols-1 gap-4 md:grid-cols-2">
                                    ...
                                    <SearchableSelect
                                        ...
                                        icon={IdCardLanyard}
                                        onSelect={(item) => handleSelectChange('card_physical', cardPhysicalTypes.find(t => String(t.id) === item?.id) ?? null)}
