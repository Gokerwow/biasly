...
export default function Navbar() {
    ...
    return (
        <nav className="fixed z-[99] w-full bg-white grid grid-cols-3 items-center px-45 shadow-md">
                ...
                {user ? (
                    <div className="group">
                        <div className="w-13 h-13 rounded-full overflow-hidden relative cursor-pointer">
                            <Image
                                src={user?.user_metadata.avatar_url ?? "/assets/images/1080full-yuna-(itzy).jpg"}
