...
export type TemplatesPages = Tables<'template_pages'>
export type TemplatesSlots = Tables<'template_slots'>
...
export type templateStatus = Enums<'binder_templates_status'>
export type BinderGrids = Enums<'grid_layout'>