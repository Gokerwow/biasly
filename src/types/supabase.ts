...
export type Database = {
  ...
  public: {
    Tables: {
      ...
      binder_cards: {
        ...
        Relationships: [
          ...
          {
            foreignKeyName: "binder_cards_photocard_id_fkey"
      ...
      binders: {
        ...
        Relationships: [
          {
            foreignKeyName: "binders_origin_template_id_fkey"
      ...
      template_slots: {
        ...
        Relationships: [
          {
            foreignKeyName: "template_slots_page_id_fkey1"
            columns: ["page_id"]
            isOneToOne: false
          ...
          {
            foreignKeyName: "template_slots_photocard_id_fkey"
            columns: ["photocard_id"]
            isOneToOne: false
            referencedRelation: "photocards"
            referencedColumns: ["id"]
      ...
      templates: {
        Row: {
          ...
          created_at: string
          description: string | null
          grid_layout: Database["public"]["Enums"]["grid_layout"] | null
          id: string
          is_official: boolean
          name: string
          status: string
    ...
    Functions: {
      create_binder_from_blank: {
        Args: { binder_payload: Json }
        Returns: string
      }
      create_binder_from_template: {
        Args: { binder_payload: Json }
        Returns: string
      }
      create_templates: { Args: { templates_payload: Json }; Returns: boolean }
      is_admin: { Args: never; Returns: boolean }
      search_browse_releases: {
    ...
    Enums: {
      ...
      binder_templates_status: "pending" | "published" | "rejected"
